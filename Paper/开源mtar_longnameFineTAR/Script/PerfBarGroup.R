...
# 读取Excel数据
excel_path <- here("Paper/开源mtar_longnameFineTAR/Throughput.xlsx")
...
# 确保输出文件夹存在
plot_dir <- here("Paper/开源mtar_longnameFineTAR/PerfBar")
...
#   bar_width = 0.7,
#   text_size = 40,
#   x_axis_text_size = 40,    # 修改：x轴刻度文字大小
#   y_axis_text_size = 40,    # 新增：y轴刻度文字大小
#   x_label_size = 40,        # 新增：x轴标签字体大小
#   y_label_size = 50,        # 新增：y轴标签字体大小
#   legend_text_size = 40,
