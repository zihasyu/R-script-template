...
exportName = "exp-longterm-lan.pdf"
...
p1 <- ggplot() + 
  # 坐标轴显示范围
  coord_cartesian(xlim =c(-0.6, 4.3), ylim = c(5, 110)) +
...
p2 <- ggplot() + 
  # 坐标轴显示范围
  coord_cartesian(xlim =c(-0.6, 4.3), ylim = c(0, 10000)) +
  
  # 设置y坐标标签
  scale_y_continuous(breaks = c(1000, 9000),
                     labels = c(1000, 9000)) +
