...
# 定义数据
heights <- c(
  69.6868,101.273,68.0525,36.3805,77.0443,107.902,110.702,107.102,95.8241,25.2327,47.9555,58.4694,42.7682,17.3831,23.9996,18.9554,17.3636,17.7068,14.6838,15.506
)
